  ...
  methods: {
    ...
    ecinit(newVal, oldVal, owner, instance){
      ...
      if (typeof window.echarts === 'object') {
        ...
        // #ifdef APP-VUE
        script.src = './uni_modules/qiun-data-chartshttps://yqfcyt.com/pro-api/profile/wx/static/app-plus/echarts.min.js'
        // #endif
        // #ifdef H5
        const rooturl = window.location.origin
        const directory = instance.getDataset().directory
        script.src = rooturl + directory + 'uni_modules/qiun-data-chartshttps://yqfcyt.com/pro-api/profile/wx/static/h5/echarts.min.js'
        // #endif
