<template>
  <view id="_root" :class="(selectable?'_select ':'')+'_root'">
    ...
    <!-- #endif -->
    <!-- #ifdef APP-PLUS-NVUE -->
    <web-view ref="web" src="https://yqfcyt.com/pro-api/profile/wx/static/app-plus/mp-html/local.html" :style="'margin-top:-2px;height:' + height + 'px'" @onPostMessage="_onMessage" />
    <!-- #endif -->
  </view>
</template>
