...
var _default = {
  data: function data() {
    return {
      ...
      menuPowers: {
        ...
        stock_supervisor: ['/pages_sub/inStorage/inStorage', '/pages_sub/outStorage/outStorage', '/pages_sub/inventoryCheck/inventoryCheck'],
        storage_supervisor: ['/pages_sub/inStorage/inStorage', '/pages_sub/outStorage/outStorage', '/pages_sub/inventoryCheck/inventoryCheck'],
        service_supervisor: ['/pages_sub/appointment/appointment', '/pages_sub/inStorage/inStorage', '/pages_sub/outStorage/outStorage'],
        service_audit_supervisor: ['/pages_sub/appointment/appointment', '/pages_sub/inStorage/inStorage', '/pages_sub/outStorage/outStorage'],
  ...
  beforeCreate: function beforeCreate() {
    ...
    Promise.resolve().then(function () {
      return _interopRequireWildcard(__webpack_require__(/*! @/utils/dict.js */ 167));
    });
  },
  ...
  methods: {
    ...
    // 获取菜单
    getWarehouseMenus: function getWarehouseMenus() {
