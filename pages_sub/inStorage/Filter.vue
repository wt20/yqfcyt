	...
	<u-popup :show="showPopup" mode="right" closeOnClickOverlay @close="showPopup = false">
		<view style="width: 82vw;padding: 8px;">
			<u--form labelPosition="left" :model="formModel" ref="formRef" labelWidth="100">
				...
				<u-form-item label="起始日期" prop="receiptOrderDateStart" borderBottom @click="showDateStart = true">
					<u--input v-model="formModel.receiptOrderDateStart" disabled placeholder="请选择起始日期"
						border="none"></u--input>
				</u-form-item>
				<u-form-item label="结束日期" prop="receiptOrderDateEnd" borderBottom @click="showDateEnd = true">
					<u--input v-model="formModel.receiptOrderDateEnd" disabled placeholder="请选择结束日期"
						border="none"></u--input>
				</u-form-item>
			</u--form>
